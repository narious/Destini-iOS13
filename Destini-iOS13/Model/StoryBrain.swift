...
struct StoryBrain {
    ...
    init() {
        ...
        self.storyElements =
            [Story(story: "You wake up on a pile of autumn leaves...", choiceOne: "stir up", choiceTwo: "stay lying down"),
             ...
             Story(story: "There are strange marking on the tree, a footprint on the soft soil warns you of a bear. A bear suddenly tunnels its way from the ground and grabs your ankles, offering you \" fresh baked goods, if you come along \". What do you do?", choiceOne: "Slash down severing the bears hands from your feet. Another one bites the dust. You moonwalk your way out of the forest.", choiceTwo: "You follow the bear to his house, leaving the weeping doe behind to enjoy a plate of fresh baked good. You baked as hell."),
             Story(story: "As you walk to the eagle it swoops down and pecks at your shirt", choiceOne: "You karate chop back down into the ground then jump up and then do a sick elbow drop.", choiceTwo: "You endure its frivilous pecking. no power without pain. metal music plays in the bacground and blood begins to streak across your face."),
    ...
    func getChoiceOne() -> String {
        return self.storyElements[self.currentPos - 1].choiceOne
    }
    
    func getChoiceTwo() -> String {
        return self.storyElements[self.currentPos - 1].choiceTwo
    }
